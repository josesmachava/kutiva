...
urlpatterns = [
    ...
    path('perfil/<int:pk>', views.PerfilDetailView.as_view() , name="perfil"),
    ...
    #                               document_root=settings.MEDIA_ROOT) auth_views.password_reset_confirm, name='password_reset_confirm'),
